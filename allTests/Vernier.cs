...
namespace MainProject {
    public class Vernier : MonoBehaviour {
        ...
        public VernierSettings createSettingsObject(string[] settingsString) {
            //this converts a string to a much faster to access object.
            VernierSettings mySettings = new VernierSettings();
        ...
        public void setSettings(VernierSettings mySettings) {
